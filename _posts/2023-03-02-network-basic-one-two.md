...
![http-network-3-way-handshake-png](/assets/img/cs/NetWork/http-network-3-way-handshake.png){: width="700" height="600" }<br/>
...
![http-network-3-way-handshake-png](/assets/img/cs/NetWork/http-network-4-way-handshake.png){: width="700" 
height="600" }<br/>
